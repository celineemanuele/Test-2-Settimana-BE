    ...
    <?php if(get_theme_mod('footer_enable',true)===true):?>
            <div class="site-info">
                <div class="site-branding">
                 <?php $cloudpress_agency_footer_copyright = get_theme_mod('footer_copyright','<p>'.__( 'Proudly powered by <a href="https://wordpress.org"> WordPress</a> | Theme: <a href="https://spicethemes.com/cloudpress-agency-wordpress-theme/" rel="nofollow">CloudPress Agency</a> by <a href="https://spicethemes.com" rel="nofollow">SpiceThemes</a>', 'cloudpress-agency' ).'</p>'); ?>
...
function cloudpress_agency_custom_light() {
    ...
    <style type="text/css">
        .header-sidebar {
            background: <?php echo esc_attr($cloudpress_agency_link_color); ?> !important;
        }
        .header-sidebar {
            background-color: <?php echo esc_attr($cloudpress_agency_link_color); ?>;
        }
        .widget .custom-social-icons li > a
        {
            color: <?php echo esc_attr($cloudpress_agency_link_color); ?>;
        }
        /*.search-box-outer .dropdown-menu {
            border-top: solid 1px <?php echo esc_attr($cloudpress_agency_link_color); ?>;
        }*/
        .search-form input[type="submit"] {
            background: <?php echo esc_attr($cloudpress_agency_link_color); ?> none repeat scroll 0 0;
            border: 1px solid <?php echo esc_attr($cloudpress_agency_link_color); ?>;
        }
        .woocommerce ul.products li.product .onsale, .products span.onsale, .woocommerce span.onsale {
            background: <?php echo esc_attr($cloudpress_agency_link_color); ?>;
        }
        .woocommerce ul.products li.product .onsale, .products span.onsale {
            background: <?php echo esc_attr($cloudpress_agency_link_color); ?>;
            border: 2px solid <?php echo esc_attr($cloudpress_agency_link_color); ?>;
        }
        ...
        .woocommerce nav.woocommerce-pagination ul li a:focus, .woocommerce nav.woocommerce-pagination ul li a:hover, .woocommerce nav.woocommerce-pagination ul li span.current {
            background-color: <?php echo esc_attr($cloudpress_agency_link_color); ?> !important;
        }
        ...
        .btn-default:focus{background: <?php echo esc_attr($cloudpress_agency_link_color); ?>;}
        /*.search-box-outer .dropdown-menu {
            border-top: solid 1px <?php echo esc_attr($cloudpress_agency_link_color); ?>;
        }*/
        ...
        .services .post:before {
            border-bottom-color: <?php echo esc_attr($cloudpress_agency_link_color); ?>;
        }
        .text-default {
            color: <?php echo esc_attr($cloudpress_agency_link_color); ?>;
        }
        .btn-animate.border {
            border: 2px solid <?php echo esc_attr($cloudpress_agency_link_color); ?>  !important;
        }
        ...
        .entry-meta .cat-links a, .entry-meta .tag-links a {
            color: <?php echo esc_attr($cloudpress_agency_link_color); ?> !important;
        }
        .site-info {
            background-color: <?php echo esc_attr($cloudpress_agency_link_color); ?>;
        }
        ...
        .woocommerce-message, .woocommerce-info {
            border-top-color: <?php echo esc_attr($cloudpress_agency_link_color); ?>;
        }
        ...
        .pagination a:hover, .pagination a.active { background-color: <?php echo esc_attr($cloudpress_agency_link_color); ?> !important; color: #fff !important;  }
        ...
        .contact-form {
            border-top: 4px solid <?php echo esc_attr($cloudpress_agency_link_color); ?>;
        }
        ...
        blockquote {
            border-left: 3px solid <?php echo esc_attr($cloudpress_agency_link_color); ?>;
        }
        ...
        .services2 .post::before {background-color: <?php echo esc_attr($cloudpress_agency_link_color); ?>;}
        .services2 .post-thumbnail i.fa {color: <?php echo esc_attr($cloudpress_agency_link_color); ?>;}
        ...
        .woocommerce-message {
            border-top-color: <?php echo esc_attr($cloudpress_agency_link_color); ?> !important;
        }
        ...
        .index6 .custom-logo-link-url .site-title a:hover {color:  <?php echo esc_attr($cloudpress_agency_link_color); ?>;}
